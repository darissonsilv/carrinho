...
require_once $_SERVER["DOCUMENT_ROOT"] . '/carrinho/controller.php/login_controller.php';
...
<div class="card1">
  <div class="card2">
    <form class="form" action="/carrinho/controller.php/login_controller.php" method="post">
